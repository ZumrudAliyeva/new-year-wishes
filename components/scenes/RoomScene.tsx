  ...
  return (
    <>
      <div className="relative h-screen w-full text-white overflow-hidden">
        ...
        <div className="absolute bottom-2 left-1/2 w-10/12 transform -translate-x-1/2 flex gap-6 md:gap-8 w-full items-end justify-center">
          {foodOptions.map((food) => {
            ...
            return (
              <motion.div
                key={food.name}
                className="cursor-pointer relative w-[120px] md:w-[180px] xl:w-[333px] flex flex-col justify-end items-center"
              ...
              >
                ...
                <div className="relative w-[120px] md:w-[180px] xl:w-[333px]">
                <div className="steam">
                  <span></span>
                  <span></span>
                  <span></span>
        ...
        {selectedFood && (
          <div className="cursor-pointer relative w-[111px] md:w-[180px] xl:w-[333px] flex flex-col justify-end items-center">
            <div className="steam">
              <span></span>
              <span></span>
              <span></span>
